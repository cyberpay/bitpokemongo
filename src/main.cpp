...
const string strMessageMagic = "bitpokemongo Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    ...
    if(pindexBest->nHeight < 20) // BITPOKEMON DISTRIBUTION + BOUNTIES 20 Millions (NO ICO ALLOWED)
    {
        nSubsidy = 700000 * COIN; // 1400000
    }
    else if(pindexBest->nHeight < 120) // 100 Blocks with 0 rewards
    {
        nSubsidy = 0 * COIN;
    }
 else if(pindexBest->nHeight < 86400) // 86280000
    {
        nSubsidy = 100 * COIN;
    }
 else if(pindexBest->nHeight < 172800) // 5184000
    {
        nSubsidy = 60 * COIN;
    }
 else if(pindexBest->nHeight < 259200) // 3456000 
    {
        nSubsidy = 40 * COIN;
    }
 else if(pindexBest->nHeight < 345600) // 2592000 Supply 19860000 
    {
        nSubsidy = 30 * COIN;
    }
...
// bitpokemongo: attempt to generate suitable proof-of-stake
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "bitpokemongo", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "WE LIKE BITPOKEMONGO. TRIBUTE COIN. ";
        CTransaction txNew;
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x21f7da9ef96020a86be438aea7be8de1c925c9d8bab8bfd0ce8008efbdf7eead"));
        block.print();
