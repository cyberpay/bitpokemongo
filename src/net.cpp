...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("bitpokemongo-ext-ip");
...
void ThreadMapPort(void* parg)
{
    ...
    RenameThread("bitpokemongo-UPnP");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "bitpokemongo " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
void ThreadDNSAddressSeed(void* parg)
{
    ...
    RenameThread("bitpokemongo-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("bitpokemongo-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("bitpokemongo-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("bitpokemongo-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. bitpokemongo is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("bitpokemongo-start");
